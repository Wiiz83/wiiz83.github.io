      ...
      <div className="container max-w-4xl mx-auto px-6 md:px-4">
        ...
        >
          ...
          <motion.div variants={skillCategoryVariants}>
            <GlassCard className="p-4">
              <h3 className="text-lg font-medium mb-3 text-center md:text-left flex items-center">
                <span className="mr-2 text-xl">🤖</span> AI Development
              </h3>
              <div className="flex flex-wrap gap-2 justify-center md:justify-start">
                {skills.aiDevelopment.map((skill, index) => (
                  <SkillTag key={skill} skill={skill} index={index} />
                ))}
              </div>
            </GlassCard>
          ...
          <motion.div variants={skillCategoryVariants}>
            <GlassCard className="p-4">
              <h3 className="text-lg font-medium mb-3 text-center md:text-left flex items-center">
                <span className="mr-2 text-xl">🧪</span> Testing Development
              </h3>
              <div className="flex flex-wrap gap-2 justify-center md:justify-start">
                {skills.testingDevelopment.map((skill, index) => (
                  <SkillTag key={skill} skill={skill} index={index} />
                ))}
              </div>
            </GlassCard>
          ...
          <motion.div variants={skillCategoryVariants}>
            <GlassCard className="p-4">
              <h3 className="text-lg font-medium mb-3 text-center md:text-left flex items-center">
                <span className="mr-2 text-xl">🛠️</span> Technical Architecture
              </h3>
              <div className="flex flex-wrap gap-2 justify-center md:justify-start">
                {skills.architectureConcepts.map((skill, index) => (
                  <SkillTag key={skill} skill={skill} index={index} />
                ))}
              </div>
            </GlassCard>
          ...
          <motion.div variants={skillCategoryVariants}>
            <GlassCard className="p-4">
              <h3 className="text-lg font-medium mb-3 text-center md:text-left flex items-center">
                <span className="mr-2 text-xl">🧩</span> Design Tools
              </h3>
              <div className="flex flex-wrap gap-2 justify-center md:justify-start">
          ...
          <motion.div variants={skillCategoryVariants}>
            <GlassCard className="p-4">
              <h3 className="text-lg font-medium mb-3 text-center md:text-left flex items-center">
                <span className="mr-2 text-xl">🚀</span> Product & Agile
              </h3>
              <div className="flex flex-wrap gap-2 justify-center md:justify-start">
                {skills.productAndAgile.map((skill, index) => (
                  <SkillTag key={skill} skill={skill} index={index} />
                ))}
              </div>
            </GlassCard>
        ...
        <motion.div variants={skillCategoryVariants}>
            <GlassCard className="p-4">
              <h3 className="text-lg font-medium mb-3 text-center md:text-left flex items-center">
                <span className="mr-2 text-xl">📝</span> Modelling & Documentation
              </h3>
              <div className="flex flex-wrap gap-2 justify-center md:justify-start">
                {skills.modellingAndDocumentation.map((skill, index) => (
                  <SkillTag key={skill} skill={skill} index={index} />
                ))}
              </div>
            </GlassCard>
